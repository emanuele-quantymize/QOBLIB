# iECO submission for johnson16-2-4

This directory contains a sanitized QOBLIB submission for the `johnson16-2-4` maximum independent-set instance. iECO stands for iterative efficient correlated optimization.
...
- Shots per run: 2,024
- Mean QPU execution-span window: 2.5582 seconds
- Mean CPU runtime for the instance-specific workflow: 1.4228 seconds
- Median CPU runtime for the instance-specific workflow: 1.3515 seconds
- Mean total runtime excluding protocol setup, compilation, provider communication, and queue time: 3.9810 seconds
...
The 120-vertex, 5,460-edge MIS instance is represented by the integer-coefficient QUBO
